      ...
      <Div2>
          ...
          <Div3>
            ...
            <Img
              ...
              <Div5>
                ...
                <Link href='/edit_profile' style={{marginLeft: '5px'}}>
                <EditButton>
            ...
            <Div9>
              <Div10>
                <Column2>
                  <Div11>
                    <Div12>
                        <Link href="/add_proposal" style={{ textDecoration: 'none' }}>
                          <Button
                            loading="lazy"
                      ...
                      <Link href={`/profile/${userData.proposer.id}`} style={{ textDecoration: 'none', maxWidth: '120px' }}>
                        <Button
                          loading="lazy"
                          src="https://cdn.builder.io/api/v1/image/assets/TEMP/baf4c644000a2ca7444ec44e15c20fa1c9dd044a60681bc1057ac431dac9c544?apiKey=76bc4e76ba824cf091e9566ff1ae9339&"
                    ...
                    <Div17>
                      ...
                      <Link href="/edit_profile" style={{ textDecoration: 'none' }}>
                        <Button
                          loading="lazy"
                          src="https://cdn.builder.io/api/v1/image/assets/TEMP/baf4c644000a2ca7444ec44e15c20fa1c9dd044a60681bc1057ac431dac9c544?apiKey=76bc4e76ba824cf091e9566ff1ae9339&"
        ...
        <Column4>
          <Div25>
            ...
            <Div29>
                <RightMenuBar>
                <Link href={`/profile/${userData.proposer.id}`}>
                <Image
                  src={`/User-512.webp`}
                  alt="Person Image"
                  width="24"
