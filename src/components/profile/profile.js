...
import {fetchProposersData } from '../../services/apiService';
...
function MyComponent(props) {
  ...
  if(userProfile){
    console.log("asdad", userProfile.user.first_name);
  }
  if (loading) {
    return <Spinner />;
  }
  ...
  return (
   ...
   <ProfileContent>
     <ProfileColumn>
       <ProfileInfo>
         <ProposerProfile>
           <ProposerTitle>{userProfile.user.first_name}'s profile</ProposerTitle>
           <ProposerImage src="https://cdn.builder.io/api/v1/image/assets/TEMP/c2a3a5c7a159d00f3f76413741945156f0dbc1cf972b7d109ae5a439fb4fafe9?apiKey=76bc4e76ba824cf091e9566ff1ae9339&" alt="Proposer" />
         ...
         <ProposerStats>
           ...
           <AwardsIcons>
              <AwardIcon key='1' src="https://cdn.builder.io/api/v1/image/assets/TEMP/219d0239c213b406c20cf50b504208c4f7a16c3d5b20364f128e47f3dc5552a1?apiKey=76bc4e76ba824cf091e9566ff1ae9339&" alt='1' />
              <AwardIcon key='2' src="https://cdn.builder.io/api/v1/image/assets/TEMP/2288abf5fb06b34a2001bee518e5d8f6b1dd83efec16ead3e887fd58ee253be9?apiKey=76bc4e76ba824cf091e9566ff1ae9339&" alt='2' />
           </AwardsIcons>
         </ProposerStats>
       </ProfileInfo>
       <VerticalDivider />
